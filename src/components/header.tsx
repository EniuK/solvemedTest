...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const isScrollingUp = currentScrollY < prevScrollY + 1;
            ...
            <a className={styles.logoLinkContainer}>
              <motion.svg width="234" height="35" viewBox="0 0 234 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.path
                  ...
                  fill="#47474C"
                />
                <motion.path d="M104.94 22.7061H111.285V24.1419H103.173V10.6783H104.94V22.7061Z" fill="#47474C" />
                <motion.path
                  ...
                  fill="#47474C"
                />
                <motion.path d="M149.368 12.1335V16.4744H156.162V18.0006H149.411V22.6781H156.65V24.1696H147.547V10.6827H156.649V12.1335H149.368Z" fill="#47474C" />
                <motion.path
                  ...
                  fill="#47474C"
                />
                <motion.path d="M201.152 16.4894H207.908V17.986H201.166V22.6919H208.426V24.1601H199.303V10.6827H208.426V12.1193H201.152V16.4894Z" fill="#47474C" />
                <motion.path
